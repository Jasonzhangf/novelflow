...
function WorldNode({ id, data }: NodeProps<WorldNodeData>) {
  // Define handle style
  ...
  return (
    ...
    <div className="scene-node-style w-[400px] min-h-[100px]"> {/* Adjusted min-height */}
      ...
      <div className="node-title-bar">
        ...
        <span className="node-name">世界结点</span> {/* Removed English */}
      </div>
      ...
      <div className="node-port-area">
        ...
        <span className="handle-label right" style={{ top: '50%' }}>世界信息</span> {/* Removed English */}
      </div>
